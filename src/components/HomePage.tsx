      ...
      <div className="relative z-10 flex flex-col items-center min-h-screen p-4">
        ...
        <div className="space-y-4 w-full max-w-md">
          <button
            ...
            className="w-full group relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-yellow-400 to-pink-500 rounded-full overflow-hidden shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
          >
          ...
          <button
            ...
            className="w-full group relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-pink-500 to-purple-500 rounded-full overflow-hidden shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
          >
            <Upload className="w-6 h-6 mr-2" />
            Upload Video
            <div className="absolute inset-0 bg-white/20 group-hover:animate-shine"></div>
